(function() {
    ...
    function init() {   
        let product = ["Куриное филе (г.)", "Блогарский перец (г.)", "Морковь (г.)", "Кетчуп/томатная паста (г.)", "Сахар (ст. ложки)","Крахмал (ст. ложки)","Соевый соус (ст. ложки)", "Растительное масло (ст. ложки)","Паприка (ч. ложки)", "Соль", "Перец черный молотый"]
